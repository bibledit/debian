...
# The script unpacks the Bibledit tarball,
...
echo W: bibledit-data: executable-not-elf-or-script usr/share/bibledit-cloud/unittests/..
...
echo Remove bibledit-cloud man page.
rm man/bibledit-cloud.1
sed -i.bak '/bibledit-cloud.1/d' CMakeLists.txt
rm CMakeLists.txt.bak
...
echo Ready creating bibledit tarball for Debian.
